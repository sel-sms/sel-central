...
foreach($search as $text)
{
  ...
  $count++;
		...
		//$sql= "SELECT distinct * from student where skills like '%$search[0]%' OR skills  like '%$search[1]%'  ";   
        ...
        <div class="container-fluid " style="margin-top: 3%;    background: #f9f9f9;">
		 ...
		 <p>Skills : <?php echo $sk ?>.<?php // echo $sql; ?></p>
                       <hr />
...
<br />
                                    ...
                                    <div class="col-md-5"><h2><a style="background:none; color:#000000" href="pro.php?q=<?php echo $q ; ?>"><?php echo $name ; ?></a></h2>
                                         <hr  style="margin: 2px!important;"/>
                                            ...
                                            <img src="images/rating.png" class="rating" /><?php } if($x=='0') { echo "NO" ;} ?>
                                             ...
                                             <li style="display:none;"><i class="fa fa-phone"></i>+(91)-<?php echo $contact_no ; ?></li>
                                    ...
                                    <div class="col-md-3 pad-top" style="padding-top: 10%;" >
                                   		   ...
                                   		   <a data-toggle="modal" data-target="#contact"> <input type="button" class="btn btn-default btn_2" value="Send Email"> </a>
...
<br /><?php if($status!=='Completed'){ ?>
 <a data-toggle="modal" data-target="#feedback<?php echo $l; ?>"> <input type="button" class="btn btn-default btn_2" value="Leave Feedback"> </a><?php } ?>
